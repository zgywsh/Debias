    ...
    for i, t in enumerate(noise_scheduler.timesteps):
        ...
        if t == 699:
            ...
            if all_gradients:
                ...
                cp.save(
                    f"/outputs/1000jobs/grad/{debias}/{num}_{job}",
                    indices,
                )
            continue
...
def count_frequencies_in_folder(fre):
    ...
    for debias in ("no_bias", "bias", "have_bias"):
        ...
        folder_path = f"/outputs/1000jobs/grad/{debias}/"
        ...
        # #
        cp.save(
            f"/outputs/1000jobs/index/gender/{debias}",
...
def gen_index(num):
    for debias in ("bias", "have_bias"):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=6) as executor:
            ...
            with os.scandir(f"/outputs/1000jobs/{debias}/") as it:
                for entry in it:
        ...
        #
        file_path = f"/outputs/1000jobs/{debias}/{num}_indices.pkl"
        #
...
def save_index(folder_path):
    ...
    output_file_path = os.path.join(folder_path, "index.txt")
...
if __name__ == "__main__":
    ...
    save_index("/outputs/1000jobs/index/gender")
